...
for filename in os.listdir(r"./strings/cmds/"):
    if filename.endswith(".yml") and filename != "en.yml":
        ...
        if missing_keys:
            print(
                f"ᴇʀʀᴏʀ: ᴍɪꜱꜱɪɴɢ ᴋᴇʏꜱ ɪɴ ꜱᴛʀɪɴɢꜱ/ᴄᴍᴅꜱ/{language_code}.yml: {', '.join(missing_keys)}"
            )
            sys.exit(1)
...
for filename in os.listdir(r"./strings/langs/"):
    if filename.endswith(".yml") and filename != "en.yml":
        ...
        try:
            ...
            print(
                "ᴛʜᴇʀᴇ ɪꜱ ᴀɴ ɪꜱꜱᴜᴇ ᴡɪᴛʜ ᴛʜᴇ ʟᴀɴɢᴜᴀɢᴇ ꜰɪʟᴇ. ᴘʟᴇᴀꜱᴇ ʀᴇᴘᴏʀᴛ ɪᴛ ᴛᴏ ᴠᴇɴᴏᴍᴄʜᴀᴛᴢ ᴀᴛ @STORM_CORE"
            )
            sys.exit()

if not commands:
    print(
        "ᴛʜᴇʀᴇ'ꜱ ᴀ ᴘʀᴏʙʟᴇᴍ ʟᴏᴀᴅɪɴɢ ᴛʜᴇ ᴄᴏᴍᴍᴀɴᴅ ꜰɪʟᴇꜱ. ᴘʟᴇᴀꜱᴇ ʀᴇᴘᴏʀᴛ ɪᴛ ᴛᴏ ᴠᴇɴᴏᴍᴄʜᴀᴛᴢ ᴀᴛ @STORM_CORE"
    )
    sys.exit()
